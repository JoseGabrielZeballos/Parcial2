...
using Parcial2_GabrielZeballosp.Models;
using Parcial2_GabrielZeballosp.Providers;
using Parcial2_GabrielZeballosp.Results;

namespace Parcial2_GabrielZeballosp.Controllers
{
    [Authorize]
